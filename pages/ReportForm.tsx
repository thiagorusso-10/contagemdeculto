            ...
            <div className="space-y-4">
                <div>
                    ...
                    <select 
                        ...
                        className="w-full border-4 border-black p-3 font-bold bg-white shadow-neo-sm focus:outline-none focus:shadow-neo transition-all"
                    >
                        {campuses.map(c => (
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full border-4 border-black p-3 font-bold shadow-neo-sm focus:outline-none focus:shadow-neo transition-all"
                        />
                    </div>
                    <div>
